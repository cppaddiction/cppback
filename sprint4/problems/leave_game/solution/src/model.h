...
public:
    ...
    void AddRetTime(double ret_time) { def_ret_time_ = ret_time; }
    double GetRetTime() const { return def_ret_time_; }
...
public:
    ...
    void AddTime(std::uint64_t time) { time_ += time; }

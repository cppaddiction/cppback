...
public:
    ...
    void AddSpecificMapDogSpeed(std::uint64_t speed) {
        specific_map_dog_speed_ = speed;
    }

    std::uint64_t GetSpecificMapDogSpeed() const {
...
private:
    ...
    std::uint64_t specific_map_dog_speed_=0;
};
...
public:
    ...
    void AddDefaultDogSpeed(std::uint64_t speed) {
        default_dog_speed_ = speed;
    }

    std::uint64_t GetDefaultDogSpeed() const {
...
private:
    ...
    std::uint64_t default_dog_speed_=0;
};

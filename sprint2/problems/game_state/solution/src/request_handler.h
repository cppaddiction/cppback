...
namespace http_handler {
    ...
    class ApiHandler {
        ...
        const std::string ALLOWED_TOKEN_SYMBOLS = "0123456789abcdef";
    ...
    public:
        explicit ApiHandler(model::Game& game, app::Players& players, model::SessionManager& sm)
            : game_{ game }, players_(players), sm_(sm) {
        }
    ...
    public:
        explicit RequestHandler(model::Game& game, const std::string& static_path, Strand api_strand, app::Players& players, model::SessionManager& sm)
            : game_{ game }, static_abs_path_{ static_path }, api_strand_{ api_strand }, players_(players), sm_(sm) {
        }
    ...
    private:
        ...
        app::Players& players_;
        model::SessionManager& sm_;
        ApiHandler api_handler_{ game_, players_, sm_ };
    };
